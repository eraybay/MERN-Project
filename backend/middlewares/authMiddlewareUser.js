...
const protectUser = asyncHandler(async (req, res, next) => {
  ...
  if (
    ...
    try {
      ...
      //This line is using the id field from the JWT payload to fetch the user from your database.
      //It then attaches the user to the req object, but it tells Mongoose not to include the password field (select("-password")).
      // This means that req.user will contain the user object for the rest of your middleware functions to use, but it won't contain the user's password.
